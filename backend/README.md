...
## Project Structure
    ...
    ├── testprojectroles_de_32726  # Django project configurations
...
1. Clone this repo and `cd testprojectroles_de_32726`
...
2. Clone this repo and `cd testprojectroles_de_32726`
